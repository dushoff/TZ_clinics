...
JD suggested censoring patients who reached the end date, and for LTFU before the end date, we want to keep them in the demoninator and will count against us.
...
\item Age Group (categorized in two different formats, right exclusive)
\end{enumerate}
